...
<?php echo $this->Form->create('TripInstance'); ?>
	<fieldset>
		<legend><?php echo __('Edit Trip Instance'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TripInstance.user_id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('TripInstance.user_id'))); ?></li>
