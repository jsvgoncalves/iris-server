...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit User'), array('action' => 'edit', $user['User']['imei'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete User'), array('action' => 'delete', $user['User']['imei']), null, __('Are you sure you want to delete # %s?', $user['User']['imei'])); ?> </li>
